import { ArrowUpRight, BarChart3, Sparkles, Target, TrendingUp } from "lucide-react";
    ...
    <section className="relative min-h-screen pt-32 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Main heading */}
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-semibold text-primary mb-6 animate-fade-in-up">
            Strategic Consulting for{" "}
            <span className="text-primary">Innovative Growth</span>
          </h1>
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in-up-delayed-2">
            Empowering businesses with strategic consulting and expert advisory services to navigate complexity and achieve sustainable success.
          </p>
