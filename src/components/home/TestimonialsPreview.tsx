...
const defaultTestimonial: TestimonialData = {
  fullName: "Princy Shah Consulting",
  companyName: "Client Engagement Team",
  industry: "Strategic Consulting",
  feedback: "We are committed to delivering structured, research-driven solutions that create measurable impact for every client we work with. Our approach combines analytical depth with practical execution to ensure lasting results.",
};

export function TestimonialsPreview() {
  const [testimonials, setTestimonials] = useState<TestimonialData[]>([defaultTestimonial]);
  ...
  }, [testimonials, nextSlide, itemsPerSlide]);
